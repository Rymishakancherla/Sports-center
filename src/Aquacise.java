    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        else
        {
                    ...
                    else
                    {
                        ...
                        if(k<4)
                        {
                            if(aquacise_array[k][4] == null || aquacise_array[k][4].equals(""))
                            {
                                ...
                                this.aquacise_array[k][3]= this.mobile_t.getText().trim();//String.valueOf(mobile);
            ...
            catch(Exception obj)
            {
                ...
                JOptionPane.showMessageDialog(this,obj);//"There is an Problem in your inserted data So pease feed correct data","Alert",JOptionPane.WARNING_MESSAGE);
                this.name_t.setText("");
                this.age_t.setText("");
                this.mobile_t.setText("");
                this.address_t.setText("");
